...
export class Sdk extends HeyApiClient {
   ...
   */
  public deleteAgent<ThrowOnError extends boolean = false>(
   ...
   */
  public addFollowup<ThrowOnError extends boolean = false>(
    options: Options<AddFollowupData, ThrowOnError>
  ) {
    return (options.client ?? this.client).post<
      AddFollowupResponses,
      AddFollowupErrors,
   ...
   */
  public stopAgent<ThrowOnError extends boolean = false>(
    options: Options<StopAgentData, ThrowOnError>
  ) {
    return (options.client ?? this.client).post<
      StopAgentResponses,
      StopAgentErrors,
   ...
   */
  public getAgentConversation<ThrowOnError extends boolean = false>(
    options: Options<GetAgentConversationData, ThrowOnError>
  ) {
    return (options.client ?? this.client).get<
      GetAgentConversationResponses,
      GetAgentConversationErrors,
   ...
   */
  public listRepositories<ThrowOnError extends boolean = false>(
