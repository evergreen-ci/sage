...
import type { AddFollowupData, AddFollowupErrors, AddFollowupResponses, CreateAgentData, CreateAgentErrors, CreateAgentResponses, DeleteAgentData, DeleteAgentErrors, DeleteAgentResponses, GetAgentArtifactData, GetAgentArtifactErrors, GetAgentArtifactResponses, GetAgentConversationData, GetAgentConversationErrors, GetAgentConversationResponses, GetAgentData, GetAgentErrors, GetAgentResponses, GetMeData, GetMeErrors, GetMeResponses, ListAgentArtifactsData, ListAgentArtifactsErrors, ListAgentArtifactsResponses, ListAgentsData, ListAgentsErrors, ListAgentsResponses, ListModelsData, ListModelsErrors, ListModelsResponses, ListRepositoriesData, ListRepositoriesErrors, ListRepositoriesResponses, StopAgentData, StopAgentErrors, StopAgentResponses } from './types.gen';
...
export class Sdk extends HeyApiClient {
     ...
     *
     * List artifacts generated by a cloud agent
     */
    public listAgentArtifacts<ThrowOnError extends boolean = false>(options: Options<ListAgentArtifactsData, ThrowOnError>) {
        return (options.client ?? this.client).get<ListAgentArtifactsResponses, ListAgentArtifactsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v0/agents/{id}/artifacts',
            ...options
        });
    }
     ...
     */
    public getAgentArtifact<ThrowOnError extends boolean = false>(options: Options<GetAgentArtifactData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetAgentArtifactResponses, GetAgentArtifactErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/v0/agents/{id}/artifacts/download',
            ...options
        });
    }
