...
export type Artifact = {
    ...
    sizeBytes: number;
    /**
     * Last modified timestamp for the artifact
     */
    updatedAt: string;
};
...
export type ListArtifactsResponse = {
    /**
     * Artifacts generated by the cloud agent
     */
...
export type AddFollowupResponse = AddFollowupResponses[keyof AddFollowupResponses];
...
export type GetAgentArtifactData = {
    body?: never;
    path: {
        /**
         * Unique identifier for the cloud agent
    ...
    query: {
        /**
         * Absolute artifact path from the list artifacts response
         */
        path: string;
    };
...
export type GetAgentArtifactErrors = {
    /**
     * Invalid request - bad agent ID format or missing path query parameter
     */
    400: Error;
    /**
     * Unauthorized - invalid or missing API key
...
export type GetAgentArtifactError = GetAgentArtifactErrors[keyof GetAgentArtifactErrors];

export type GetAgentArtifactResponses = {
    /**
     * Artifact URL retrieved successfully
     */
    200: GetArtifactResponse;
};

export type GetAgentArtifactResponse = GetAgentArtifactResponses[keyof GetAgentArtifactResponses];
