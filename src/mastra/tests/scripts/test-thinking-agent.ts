...
async function testThinkingAgent() {
  ...
  if (executionIndex !== -1 && args[executionIndex + 1]) {
    logMetadata.execution = parseInt(args[executionIndex + 1]!);
  }
  ...
  try {
    ...
    if (interactive) {
      ...
      console.log('This simulates the chatbot experience users will have in the UI.');
      console.log('─'.repeat(60));
      
      // Send initial greeting
      await sendMessage("Hello! I'm ready to help with your Evergreen questions.");
