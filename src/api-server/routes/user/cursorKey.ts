...
router.get(
  '/cursor-key',
  async (req: Request, res: Response<GetKeyResponse | ErrorResponse>) => {
...
router.post(
  '/cursor-key',
  async (req: Request, res: Response<UpsertKeyResponse | ErrorResponse>) => {
    const userId = res.locals.userId as string;
    const requestId = res.locals.requestId as string;
...
router.delete(
  '/cursor-key',
  async (req: Request, res: Response<DeleteKeyResponse | ErrorResponse>) => {
    const userId = res.locals.userId as string;
    const requestId = res.locals.requestId as string;
